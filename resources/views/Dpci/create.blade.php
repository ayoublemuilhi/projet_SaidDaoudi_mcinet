    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('dpci.store')}}" method="POST" autocomplete="off">
                        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary">@lang('dpci.btn_add_edit')</button>
                        </div>
