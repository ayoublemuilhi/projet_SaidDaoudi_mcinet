    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('regions.update',$region->id)}}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputName" name="region_fr" dir="ltr"
                                   title="@lang('regions.form.title')" value="{{$region->region_fr}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputName" name="region_ar" dir="rtl"
                                   title="@lang('regions.form.title')" value="{{$region->region_ar}}">
                        </div>
