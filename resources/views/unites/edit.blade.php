...
@section('content')
    <!-- row -->
    <div class=" pb-0">
        <a href="{{route('unites.index')}}" class="btn btn-primary" style="color: whitesmoke"><i class="fas fa-undo"></i> @lang('sidebar.return') </a>
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('unites.update',$unite->id)}}" method="POST" autocomplete="off">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputName" name="unite_fr" dir="ltr"
                                   title="@lang('unites.form.title')" value="{{$unite->unite_fr}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputName" name="unite_ar" dir="rtl"
                                   title="@lang('unites.form.title')" value="{{$unite->unite_ar}}">
                        </div>
