        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">@lang('sidebar.qualites')</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                     @lang('qualites.add qualite') </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('qualites.store')}}" method="POST" autocomplete="off">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputName" name="qualite_fr" dir="ltr"
                                       title="@lang('qualites.form.title')" value="{{old('qualite_fr')}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputName" name="qualite_ar" dir="rtl"
                                       title="@lang('qualites.form.title')" value="{{old('qualite_ar')}}">
                            </div>
