...
@endsection
@section('title')
    @lang('type_credit.add type credit')
@stop
        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">@lang('sidebar.typeCredit')</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                     @lang('type_credit.add type credit') </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('typeCredit.store')}}" method="POST" autocomplete="off">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputName" name="type_credit_fr" dir="ltr"
                                       title="@lang('unites.form.title')" value="{{old('type_credit_fr')}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputName" name="type_credit_ar" dir="rtl"
                                       title="@lang('unites.form.title')" value="{{old('type_credit_ar')}}">
                            </div>
