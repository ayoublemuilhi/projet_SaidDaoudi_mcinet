...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">@lang('sidebar.attributions')</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                     @lang('attributions.edit attribution') </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    <form action="{{route('attributions.update',$attribution->id)}}" method="POST" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <select name="secteur" class="form-control SlectBox">
                                ...
                                @foreach($secteurs as $secteur)
                                    <option @if($secteur->id === $attribution->secteur_id) selected="selected" @endif value="{{$secteur->id}}">{{$secteur->secteur}}</option>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary">@lang('attributions.btn_add_edit')</button>
                        </div>
