    ...
    <div class="container-fluid">
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href=""><img src="{{URL::asset('assets/img/brand/logo.png')}}" class="logo-1" alt="logo"></a>
                <a href=""><img src="{{URL::asset('assets/img/brand/logo-white.png')}}" class="dark-logo-1" alt="logo"></a>
                <a href=""><img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="logo-2" alt="logo"></a>
                <a href=""><img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="dark-logo-2" alt="logo"></a>
            </div>
                        ...
                        <div class=" nav-itemd-none d-md-flex">
                            @if($localeCode === "ar")
                                <a hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL("ar", null, [], true) }}" class="d-flex  nav-item nav-link pl-0 country-flag1">
                                    <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/morocco.png')}}" alt="img" style="height:22px !important;"></span>
                                    <div class="my-auto">
                                ...
                                <a rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL("fr", null, [], true) }}" class="d-flex  nav-item nav-link pl-0 country-flag1">
                                    <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/french_flag.jpg')}}" alt="img" style="height: 16px !important;"></span>
                                    <div class="my-auto">
                                        <strong class="mr-2 ml-2 my-auto"> {{ $properties['native'] }}</strong>
                                    </div>
                                </a>
