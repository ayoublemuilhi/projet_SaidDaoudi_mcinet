        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">@lang('sidebar.objectifs')</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                     @lang('objectifs.add objectif') </span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('objectifs.store')}}" method="POST" autocomplete="off">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputName" name="objectif_fr" dir="ltr"
                                       title="@lang('objectifs.form.title')" value="{{old('objectif_fr')}}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputName" name="objectif_ar" dir="rtl"
                                   title="@lang('objectifs.form.title')" value="{{old('objectif_ar')}}">
                        </div>
