...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">@lang('sidebar.objectifs')</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/  @lang('sidebar.liste objectif')</span>
            </div>
        </div>
...
@section('content')
    ...
    <div class="modal" id="supprimer_objectif">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">@lang('objectifs.modal supprimer')</h6><button aria-label="Close" class="close" data-dismiss="modal"
                ...
                <form action="objectifs/destroy" method="post">
                    ...
                    <div class="modal-body">
                        <p>@lang('objectifs.modal validation supprision')</p><br>
                        <input type="hidden" name="id" id="id" value="">
                        <input class="form-control" name="objectif_name" id="objectif_name" type="text" readonly  >
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">@lang('objectifs.modal validation close')</button>
                        <button type="submit" class="btn btn-danger">@lang('objectifs.modal validation confirm')</button>
                    </div>
...
@section('js')
    ...
    <script>
        $('#supprimer_objectif').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget)
            var id = button.data('id')
            var objectif_name = button.data('objectif_name')
            var modal = $(this)
            modal.find('.modal-body #id').val(id);
            modal.find('.modal-body #objectif_name').val(objectif_name);
        })
    </script>
@endsection
