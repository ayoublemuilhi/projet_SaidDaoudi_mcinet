    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('actions.store')}}" method="POST" autocomplete="off">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputName" name="action_fr" dir="ltr"
                                       title="@lang('actions.form.title')" value="{{old('action_fr')}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="inputName" name="action_ar" dir="rtl"
                                       title="@lang('actions.form.title')" value="{{old('action_ar')}}">
                            </div>
